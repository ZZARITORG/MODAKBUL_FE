            ...
            children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 7.w),
                      Text('${profileLength}명',
                          style: Theme.of(context).textTheme.body3.copyWith(color: ColorSchemes.gray200)
                      ),
                      SizedBox(width:6.w ),
                      IconButton(
                          onPressed: (){},
              ...
              SizedBox(
                ...
                child: Text(
                    ...
                    style: Theme.of(context).textTheme.smallHeadLine1.copyWith(color: ColorSchemes.gray500)
                ),
              ),
              SizedBox(height: 8.h),
              SizedBox(
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                      date,
                      style: Theme.of(context).textTheme.body3.copyWith(color: ColorSchemes.orange200)
                  ),
                  SizedBox(height: 6.h),
