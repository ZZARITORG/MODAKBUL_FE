      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SettingMenu.arrow(menu: '계정정보 관리', icon: IconPath.verifiedUser),
            SizedBox(height: 18.h),
            SettingMenu.arrow(menu: '알림설정', icon: IconPath.notificationsBell),
            SizedBox(height: 18.h),
            SettingMenu.arrow(menu: '친구설정', icon: IconPath.friend),
            ...
            SizedBox(height: 14.h),
            SettingMenu.arrow(menu: '이용약관', icon: IconPath.lock),
            SizedBox(height: 18.h),
            SettingMenu.arrow(menu: '정보', icon: IconPath.description),
              ...
              child: Row(
                ...
                SizedBox(
                    ...
                    child: SvgPicture.asset(IconPath.powerSettingsNew,
                        width: 18.r, fit: BoxFit.scaleDown)),
                SizedBox(width: 2.w),
                Text(
                  '로그아웃',
                  style: Theme.of(context)
